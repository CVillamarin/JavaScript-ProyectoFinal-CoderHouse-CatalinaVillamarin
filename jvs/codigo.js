...
function cargarProductos() {
    ...
    productos.push(new Impresiones("482354","Jugete para la ansiedad",200,"./imagenes/ansiedadjfif.jfif"));
    productos.push(new Impresiones("967425","Organizador de cables",150,"./imagenes/organizador.jpg"));
    productos.push(new Impresiones("843521","Cubre Lampara",550,"./imagenes/lampara.jpg"));
    productos.push(new Impresiones("744592","Light-Saber",1150,"./imagenes/lightsaber.jpg"));
}
